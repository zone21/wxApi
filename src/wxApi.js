	...
	var wxApi = {
		...
		init: function (fn) {
			...
			switch (window.location.hostname.replace(/\w+((\.\w+)+)/, "$1")) {
				...
				wxApiSignUrl = CONSTANTS.wxApiSignUrl_online;
					break;
				case ".pcauto.com.cn":
				wxApiSignUrl = CONSTANTS.wxApiSignUrl_auto;
					break;
				case ".pclady.com.cn":
				wxApiSignUrl = CONSTANTS.wxApiSignUrl_lady;
					break;
				case ".pcbaby.com.cn":
				wxApiSignUrl = CONSTANTS.wxApiSignUrl_baby;
					break;
				case ".pcgames.com.cn":
				wxApiSignUrl = CONSTANTS.wxApiSignUrl_games;
					break;
				case ".pchouse.com.cn":
				wxApiSignUrl = CONSTANTS.wxApiSignUrl_house;
					break;
				default :
			...
			var _this = this;
			_this.getScript({
				url: CONSTANTS.wxApiJSUrl,// 请求微信api的js接口
				callback: function(){
					_this.getScript({
